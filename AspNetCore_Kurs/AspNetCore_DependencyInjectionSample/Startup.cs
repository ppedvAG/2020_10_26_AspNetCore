...
namespace AspNetCore_DependencyInjectionSample
{
    public class Startup
    {
        ...
        {
            //ConfigureServices Hinzufügen von ASP.NET Core Features + Dritt-Libraries
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                //Einstellungen die nur für die Development-Ebene verfügbar sind. 
                app.UseDeveloperExceptionPage();

            }
            else if (env.IsEnvironment("Project X"))
            {
                //Einstellungen die nur für die Enviroment verfügbar sind. 
            }
            else
            {
